...
export async function up({ db, payload, req }: MigrateUpArgs): Promise<void> {
  ...
  CREATE TYPE "public"."enum_pages_blocks_cta_links_link_color" AS ENUM('primary', 'secondary', 'accent');
  ...
  CREATE TYPE "public"."enum_pages_blocks_posts_carousel_populate_by" AS ENUM('collection', 'selection');
  CREATE TYPE "public"."enum_pages_blocks_posts_carousel_relation_to" AS ENUM('posts', 'case-studies');
  ...
  CREATE TYPE "public"."enum__pages_v_blocks_cta_links_link_color" AS ENUM('primary', 'secondary', 'accent');
  ...
  CREATE TYPE "public"."enum__pages_v_blocks_posts_carousel_populate_by" AS ENUM('collection', 'selection');
  CREATE TYPE "public"."enum__pages_v_blocks_posts_carousel_relation_to" AS ENUM('posts', 'case-studies');
  ...
  CREATE TABLE "pages_blocks_posts_carousel" (
  	...
  	"id" varchar PRIMARY KEY NOT NULL,
  	"intro_content" jsonb,
  	"populate_by" "enum_pages_blocks_posts_carousel_populate_by" DEFAULT 'collection',
  	"relation_to" "enum_pages_blocks_posts_carousel_relation_to" DEFAULT 'posts',
  	"limit" numeric DEFAULT 10,
  	"block_name" varchar
  );
  ...
  CREATE TABLE "_pages_v_blocks_posts_carousel" (
  	...
  	"id" serial PRIMARY KEY NOT NULL,
  	"intro_content" jsonb,
  	"populate_by" "enum__pages_v_blocks_posts_carousel_populate_by" DEFAULT 'collection',
  	"relation_to" "enum__pages_v_blocks_posts_carousel_relation_to" DEFAULT 'posts',
  	"limit" numeric DEFAULT 10,
  	"_uuid" varchar,
  	"block_name" varchar
  );
...
export async function down({ db, payload, req }: MigrateDownArgs): Promise<void> {
  ...
  DROP TYPE "public"."enum_pages_blocks_posts_carousel_populate_by";
  DROP TYPE "public"."enum_pages_blocks_posts_carousel_relation_to";
  ...
  DROP TYPE "public"."enum__pages_v_blocks_posts_carousel_populate_by";
  DROP TYPE "public"."enum__pages_v_blocks_posts_carousel_relation_to";
